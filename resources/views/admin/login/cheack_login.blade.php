...
{!! Html::style('login/css/font-awesome.min.css') !!}
{!! Html::style('login/css/ionicons.min.css') !!}
{!! Html::style('login/css/AdminLTE.min.css') !!}
{!! Html::style('login/css/blue.css') !!}
  ...
  <div class="login-box-body">
    ...
    <form class="login-form" action="{{route('postlogin')}}" method="POST">
      ...
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="اسم المستخدم" name="user_name">
...
{!! Html::script('login/js/jquery.min.js') !!}
{!! Html::script('login/js/bootstrap.min.js') !!}
{!! Html::script('login/js/icheck.min.js') !!}
<script>
    $(function () {
        $('input').iCheck({
