                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                @foreach ($homecontents as $homecontent )
                                    <tr>
                                        ...
                                        <td>{{ $homecontent->created_at->diffForHumans() }}</td>
                                        <td>
                                            <a class="btn btn-primary" href="{{url('admins/homecontent/'.$homecontent->id.'/edit')}}"><i class="fa fa-edit"></i></a>
                                            <form method="Post" action="{{route('homecontent.destroy',$homecontent->id)}}" class="form_inline">
                                                {{csrf_field()}}
