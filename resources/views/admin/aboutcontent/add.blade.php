    ...
    <div class="content">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{url('admins/aboutcontent')}}">About Content</a></li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Main Content</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        @if(count($errors)>0)
                        ...
                        <form role="form" action="{{url('admins/aboutcontent')}}" method="post" enctype="multipart/form-data">
                            {{ csrf_field () }}
                            <div class="box-body">
