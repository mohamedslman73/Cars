                    ...
                    <form role="form" action="{{route('Question.update',$question->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="editble-txt"  rows="8" required name="question">{{ $question->question }}</textarea>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Answer</label>
                                <textarea class="editble-txt"  rows="8" required name="answer">{{ $question->answer }}</textarea>
                            </div>
