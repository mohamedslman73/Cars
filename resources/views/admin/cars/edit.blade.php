            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" action="{{route('cars.update',$car->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="name" class="form-control" name="name" id="exampleInputEmail1" placeholder="Enter name" value="{{$car->name}}">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Selling Price</label>
                                    <input type="text" class="form-control" name="price" id="exampleInputEmail1" placeholder="Enter price" value="{{$car->price}}">
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputEmail1">Model</label>
                                    <input type="text" class="form-control" name="model" id="exampleInputEmail1" placeholder="Enter model" value="{{$car->model}}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="body_type" id="exampleInputEmail1" value="{{$car->body_type}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="construction_year" id="exampleInputEmail1" placeholder="Enter construction_year" value="{{$car->construction_year}}">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">colour</label>
                                    <select class="form-control" name="colour" id="exampleInputEmail1">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="mileage" id="exampleInputEmail1" placeholder="Enter mileage" value="{{$car->mileage}}">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">transmission</label>

                                    <select name="transmission" class="form-control" id="exampleInputEmail1">
                                ...
                                <div class="form-group">
                                    <label>fuel</label>
                                    <select class="form-control" name="fuel" id="exampleInputEmail1">
                                ...
                                <div class="form-group">
                                    <label>weight</label>
                                    <input type="text" class="form-control" name="weight" id="exampleInputEmail1" placeholder="Enter weight" value="{{$car->weight}}">
                                </div>
                                <div class="form-group">
                                    <label>	decoration</label>
                                    <input type="text" class="form-control" name="decoration" id="exampleInputEmail1" placeholder="Enter decoration" value="{{$car->decoration}}">
                                </div>

                                <div class="form-group">
                                    <label>	cylinder_capacity</label>
                                    <input type="text" class="form-control" name="cylinder_capacity" id="exampleInputEmail1" placeholder="Enter cylinder_capacity" value="{{$car->cylinder_capacity}}">
                                </div>
                                <div class="form-group">
                                    <label>c02_emission</label>
                                    <input type="text" class="form-control" name="c02_emission" id="exampleInputEmail1" placeholder="Enter c02_emission" value="{{$car->c02_emission}}">
                                </div>
                                <div class="form-group">
                                    <label>consumption_of</label>
                                    <input type="text" class="form-control" name="consumption_of" id="exampleInputEmail1" placeholder="Enter consumption_of" value="{{$car->consumption_of}}">
                                </div>
                                <div class="form-group">
                                    <label>consumption_city</label>
                                    <input type="text" class="form-control" name="consumption_city" id="exampleInputEmail1" placeholder="Enter consumption_city"  value="{{$car->consumption_city}}">
                                </div>
                                <div class="form-group">
                                    <label>consumption_highway</label>
                                    <input type="text" class="form-control" name="consumption_highway" id="exampleInputEmail1" placeholder="Enter consumption_highway" value="{{$car->consumption_highway}}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="vat_margin" id="exampleInputEmail1" placeholder="Enter vat_margin" value="{{$car->vat_margin}}">
                                </div>
                                <div class="form-group">
                                    <label>Rent price</label>
                                    <input type="text" class="form-control" name="new_price" id="exampleInputEmail1" placeholder="Enter new_price" value="{{$car->new_price}}">
                                </div>

                                <div class="form-group">
                                    <label>	minimum_driver_age</label>
                                    <input type="text" class="form-control" name="minimum_driver_age" id="exampleInputEmail1" placeholder="Enter minimum_driver_age" value="{{$car->minimum_driver_age}}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="access[]" id="sel_acss" multiple>
